...
<div id="post-grid" class="post-grid thirds">
  ...
  <?php if(is_author()){ ?>
    ...
    <?php
      ...
      echo do_shortcode('[ajax_load_more container_type="div" css_classes="post-grid" author="'.$author.'"]');
    ?>
  <?php } ?>
  <?php if(is_category()){ ?>
    <?php
    ...
    ?>
      ...
      <?php
      echo do_shortcode('[ajax_load_more container_type="div" css_classes="post-grid" category="'.$category.'"]');
    ?>
  <?php } ?>
  <?php if(is_tag()){ ?>
      ...
      echo do_shortcode('[ajax_load_more container_type="div" css_classes="post-grid" tag="'.$tag.'"]');
    ?>
  <?php } ?>
